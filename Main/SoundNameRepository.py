class SoundNameRepository:
    ...
    __SOUND_NAME_DICT = {'CALCING': __PATH + "calcing.wav", 'LAUGHTER1': __PATH + "laughter1.wav", 'LAUGHTER2': __PATH + "laughter2.wav",
                         'LAUGHTER3': __PATH + "laughter3.wav", 'LAUGHTER4': __PATH + "laughter4.wav", 'LAUGHTER5': __PATH + "laughter5.wav", 'PHRASE': __PATH + "phrase.wav", 'START': __PATH + "start.wav", 'ERROR': __PATH + "error.wav", 'BAD': __PATH + "bad.wav"}
